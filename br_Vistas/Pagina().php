		...
		<!-- ============================= -->
		 ...
		 <div class="row">
     		<div class="principal">
		      ...
		      <div class="col-md-2">
		      	<a target="_blank" href="http://www.bethelradio.fm">
	                ...
	                <div class="carousel-inner">
	                    <div class="item active">
	                    	<a href="LaHoraDeLaTransformacion.php">
		                        <img src="includes/img/sliders/s01.png" class="img-responsive link">
	                    	</a>
	                    </div>
	                    <div class="item">
		                    <a href="LaHoraDeLaTransformacion.php">
		                        <img src="includes/img/sliders/s02.png" class="img-responsive link">
		                    </a>    
	                    </div>
	                    <div class="item">
	                    	<a href="LaHoraDeLaTransformacion.php">
	                        <img src="includes/img/sliders/s03.png" class="img-responsive link">
	                        </a>
	                    </div>
	                </div>
				...
				<div class="btn-accesos">
					<a href="produccion.php">
						<div class="col-md-3 col-md-offset-2">
							<img class="link img" src="includes/img/sistema-audio.png">		
						</div>
					</a>
					
					<div class="col-md-2">
						<a href="peticiondeoracion.php">	
							<img class="link img" src="includes/img/peticion-oracion.png">
						</a>
					</div>
					...
					<div class="col-md-3">
						<a target="_blank" href="https://play.google.com/store/apps/details?id=com.bethel.radio">	
							<img class="link img" src="includes/img/aplicacion-movil2.1.png">					
						</a>
					</div>
				</div>
				</center>
	          ...
	          <div class="col-md-10 col-md-offset-1 azul">
		          ...
		          <ul class="bloque-programa">
			            ...
			            <a href="produccion.php?t=volvamos-a-dios">
			              <img class="programa img-responsive" src="includes/img/volvamos-a-Dios.png">
			              </a> 
			            </li>
			            <li class="align-horizontal">
			            	<a href="produccion.php?t=la-hora-de-la-transformacion">
			              		<img class="programa img-responsive" src="includes/img/ht.png">
			            	</a>
			            </li>
			            <li class="align-horizontal">
			            <a href="produccion.php?t=impacto-evangelistico">
			              <img class="programa img-responsive" src="includes/img/impacto-evangelistico.png">
			            </a> 
			            </li>
			            <li class="align-horizontal">
			             <a href="produccion.php?t=respuesta-pastoral">
			              <img class="programa img-responsive" src="includes/img/respuesta-pastoral.png">
			            </a>
			            </li>
		          </ul>
			...
			$redaccion= (substr($redaccion1, 0, 131));
	        	...
	        	<div class="col-md-5 borde-r2">
		        	...
		        	<div class="publicidad">
		        		<img class="img-responsive link" src="includes/img/publicidad.png">
		        	</div>
			...
			<div class="container">	
				...
				<div class="row">
					<div class="col-md-10 col-md-offset-1 white">
						<div class="row">
							<div class="col-md-4">
								<img class="img-responsive redes-sociales" src="includes/img/moviles.png"/>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-8 col-md-offset-2">
						<img class="img-responsive" src="includes/img/forfamily.jpg"/>
					</div>
				</div>
...
Con el paso de los años, nuestra cadena creció, convirtiéndose en una de las más importantes del país, alcanzando a todo el Perú; desde pequeños caseríos hasta grandes urbes. Señal en Lima. El 20 de marzo del año 2010 se hacía realidad un sueño. Bethel Radio se escuchaba en la capital peruana en los 1360 de la amplitud modulada, para después trasladarse a los 1570 AM, dial en el permanecemos hasta la fecha. Nuestra historia se sigue escribiendo gracias a nuestro Señor Jesucristo y al respaldo del Pueblo de Dios.
					...
					<div class="col-md-5">
						<img class="img-responsive imagen" width="100%" src="includes/img/consola2.png">
					</div>
				</div>

				<div class="row">
					<div class="col-md-5 col-md-offset-1">
						<img class="img-responsive imagen" width="100%" src="includes/img/misionvision.jpg">
					</div>
...
-->
        ...
        <div u="loading" style="position: absolute; top: 0px; left: 0px;">
            ...
            <div style="position: absolute; display: block; background: url(includes/img/tecnologia/loading.gif) no-repeat center center;
        ...
        <!-- Slides Container -->
         ...
         <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 800px; height: 356px; overflow: hidden;">   
        	<div>
                <img class="img-responsive" u="image" src="includes/img/tecnologia/CONTROLES_RADIO_BETHEL_021.png" />
                <img class="img-responsive" u="thumb" src="includes/img/tecnologia/CONTROLES_RADIO_BETHEL_021_thum.png "/>
            </div>
            <div>
                <img class="img-responsive" u="image" src="includes/img/tecnologia/CONTROLES_RADIO_BETHEL_032.png" />
                <img class="img-responsive" u="thumb" src="includes/img/tecnologia/CONTROLES_RADIO_BETHEL_032_thum.png "/>
            </div>
            <div>
                <img class="img-responsive" u="image" src="includes/img/tecnologia/CONTROLES_RADIO_BETHEL_037.png" />
                <img class="img-responsive" u="thumb" src="includes/img/tecnologia/CONTROLES_RADIO_BETHEL_037_thum.png "/>
            </div>
            <div>
                <img class="img-responsive" u="image" src="includes/img/tecnologia/CONTROLES_RADIO_BETHEL_039.png" />
                <img class="img-responsive" u="thumb" src="includes/img/tecnologia/CONTROLES_RADIO_BETHEL_039_thum.png "/>
            </div>
            <div>
                <img class="img-responsive" u="image" src="includes/img/tecnologia/CONTROLES_RADIO_BETHEL_040.png" />
                <img class="img-responsive" u="thumb" src="includes/img/tecnologia/CONTROLES_RADIO_BETHEL_039_thum.png "/>
            </div>
            <div>
                <img class="img-responsive" u="image" src="includes/img/tecnologia/CONTROLES_RADIO_BETHEL_044.png" />
                <img class="img-responsive" u="thumb" src="includes/img/tecnologia/CONTROLES_RADIO_BETHEL_044_thum.png "/>
            </div>
            <div>
                <img class="img-responsive" u="image" src="includes/img/tecnologia/CONTROLES_RADIO_BETHEL_045.png" />
                <img class="img-responsive" u="thumb" src="includes/img/tecnologia/CONTROLES_RADIO_BETHEL_045_thum.png  "/>
            </div>
            <div>
                <img class="img-responsive" u="image" src="includes/img/tecnologia/CONTROLES_RADIO_BETHEL_047.png" />
                <img class="img-responsive" u="thumb" src="includes/img/tecnologia/CONTROLES_RADIO_BETHEL_047_thum.png "/>
            </div>
...
<br/>
	...
	<div class="tab-content">
	 ...
	 <div class="franja-celeste">
	 	<img class="img-responsive" src="includes/img/franja-celeste.png">
	 </div>
...
<div class="fondo-blanco">
	...
	<div class="row">
		...
		<div class="col-md-5">
			...
			<img class="img-responsive" src="includes/img/mapa.png" alt=".......Pronto">
		</div>
...
<div class="col-md-10 col-md-offset-1">
  ...
  <!--       <div class="col-xs-2"> <!-- required for floating -->
          <!-- Nav tabs ->
          <ul class="nav nav-tabs-l tabs-left-br">
            <li class="active"><a href="#todos" data-toggle="tab">Todos</a></li>
            <li><a href="#cristianos" data-toggle="tab">Cristianos</a></li>
            <li><a href="#predicas" data-toggle="tab">Predicas</a></li>
            <li><a href="#noticiosos" data-toggle="tab">Noticiosos</a></li>
            <li><a href="#Infantiles" data-toggle="tab">Infantiles</a></li>
            <li><a href="#Especiales" data-toggle="tab">Especiales</a></li>
            <li><a href="#Educativos" data-toggle="tab">Educativos</a></li>
          </ul>
        </div>
        ...
        <div class="col-xs-10">
          <!-- Tab panes ->
          <div class="tab-content">
            <div class="tab-pane active" id="todos">aqui van todas las categorias</div>
            <div class="tab-pane" id="cristianos">aqui van cristianos</div>
            <div class="tab-pane" id="predicas">

            	<p class="lead">Prédicas</p>
            ...
            <div class="tab-pane" id="noticiosos">aqui van Noticiosos</div>
            <div class="tab-pane" id="Infantiles">aqui van Infantiles</div>
            <div class="tab-pane" id="Especiales">aqui van Especiales</div>
            <div class="tab-pane" id="Educativos">aqui van Educativos</div>
          </div>
        </div> -->
