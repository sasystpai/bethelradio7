...
class ControlActualizarEntrada extends FormMensaje
{
	function ActualizarEntrada($titulo,$redaccion,$tags, $categoria, $privilegios,$id_entrada,$fecha_publicacion,$id_usuario){
		...
		$mensaje = "Mensaje: <br>";
						...
						$rs=$OBJEntidad -> ActualizarEntrada_por_id($titulo, $redaccion, $tags, $categoria, $fecha_publicacion, $id_entrada);
