...
class FormularioSecciones extends Pagina2
{
	
	function MostrarFormularioSecciones($secciones,$privilegios)
	{
		    ?>
<br/>
<br/>
...
<div class="alert alert-warning">
    ...
    <div class="clearfix">
      <div class="form-inline">
      	<div class="form-group">
       	...
       	<div class="form-group">
      		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-sm btn-warning" href="IndexNuevaSeccion.php">Añadir Nueva Sección</a>	
       	</div>
      </div>
     <br/>
     <br/>
      ...
      <thead>
        <tr>
	      	...
	      	<th width="100">Ítem</th>
	      	<th width="250">Sección</th>
  ...
  if($secciones!=0){
    ...
    $i=0;
      while($row=mysql_fetch_array($secciones)){
        //echo "->".$rows;
        $i++;
        $cod=$row['id_seccion'];
        $cod1=serialize($cod);
        ...
        ?>
            ...
            <form method="POST" action="../ModuloAdministrador/GetEstadoSeccion.php"> 
              ...
              <button type="submit" name="eliminar"     class="btn btn-danger btn-xs" 
                      onclick="return confirm('Está seguro que desea eliminar la sección:\n -><?php echo utf8_encode($row['descripcion'])?>');"
   ...
   ?>
    ...
    <tr>
            <th colspan="4"><?php echo "no hay secciones"?></th>
    </tr>
   <?php
